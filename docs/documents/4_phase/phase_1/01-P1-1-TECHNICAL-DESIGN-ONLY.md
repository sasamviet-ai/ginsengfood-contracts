...
| **FILE**             | 01-P1-1-TECHNICAL-DESIGN-ONLY.docx                     |
|----------------------|--------------------------------------------------------|
| **PHASE**            | PHASE-01 — PRODUCT / SKU / RECIPE / PRODUCT ACTIVATION |
| **MODE**             | MODE: TECHNICAL DESIGN ONLY                            |
| **PROMPT TIẾP THEO** | PROMPT-P1.2A — LIMITED IMPLEMENTATION                  |
...
Chuyển blocker thành task kỹ thuật.
...
BLOCKED — PROMPT-P1 ANALYSIS REPORT REQUIRED

Nếu thiếu gap/conflict/blocker matrix, agent phải báo:

BLOCKED — PROMPT-P1 ANALYSIS REPORT INCOMPLETE
...
# 9. P1 BLOCKER HANDLING

Agent phải chuyển blocker từ P1 Analysis Report thành bảng xử lý.
...
PROMPT-P1.1 FINAL STATUS: TECHNICAL DESIGN HANDOFF ONLY  
...
PROMPT-P1.1 DOCUMENT STATUS: CLEAN FINAL
