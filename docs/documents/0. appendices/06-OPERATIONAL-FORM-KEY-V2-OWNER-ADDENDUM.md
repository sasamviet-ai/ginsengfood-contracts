...
Owner approval: `D1=A` on 2026-08-21. At the cross-repository contract boundary, `form_key` is the canonical Operational Form identity.
...
- All 30 keys are valid for read/history. `AFTER_DRYING_QC` is retired and cannot be created.
...
3. v1 providers never represent FRM-28 through FRM-30 by inventing v1 enum values.
