...
TECH-02 không thay PACK-04 về giá/quote/order/payment.
TECH-02 không thay PACK-06 về AI Advisor.
...
| Downstream | Phụ thuộc TECH-02 |
| --- | --- |
| Operational Core | Cần SKU, ingredient, recipe, formula snapshot |
| Demand / MRP | Cần BOM, formula, ingredient, scaling rule |
| Commerce Runtime | Cần SKU active, product activation, product identity |
| AI Advisor | Cần Product Knowledge approved, public product name |
| Facebook Gateway | Cần product scope khi reply/handoff |
| Ads Measurement | Cần SKU/product mapping để đo doanh thu |
| MC AI Live | Cần Product Scope, script sản phẩm được cue |
| IVR | Không trực tiếp tạo sản phẩm, nhưng order xác nhận phải gắn SKU hợp lệ |
| Public Trace | Cần product/SKU public identity |
| MISA / Accounting | Cần mapping SKU, nguyên liệu, thành phẩm nếu scope có |
...
PACK-04 — Commerce Runtime / Quote / Cart / Order / Payment / Shipping.

PACK-06 — AI Advisor / Product Knowledge / Claim Guard.
...
| Layer | Nội dung |
| --- | --- |
| Internal Knowledge | Dữ liệu nội bộ, technical, formula, operation, claim source |
| Public Knowledge | Nội dung được phép nói với khách |
...
COMMERCE_PRODUCT_SCOPE = BLOCKED
AI_PRODUCT_SCOPE = BLOCKED
LIVE_PRODUCT_SCOPE = BLOCKED
ADS_PRODUCT_SCOPE = BLOCKED
...
PACK-04 — Commerce dependency.

PACK-06 — AI Product Knowledge dependency.
...
Nếu TECH-02 chưa clear, downstream production scope liên quan sản phẩm phải BLOCKED.
...
PRODUCT_IMPLEMENTATION_STATUS = PENDING
PRODUCT_SMOKE_STATUS = PENDING
PRODUCT_EVIDENCE_STATUS = PENDING
PRODUCT_RELEASE_READY = NO
PRODUCT_PRODUCTION_READY = NO
...
TECH_02_PART_1_GATE = FAILED
PRODUCT_DOMAIN_GATE = BLOCKED
DOWNSTREAM_PRODUCT_DEPENDENCY = BLOCKED
...
TECH-02_PART_1 = DOCUMENTATION_COMPLETE
PRODUCT_DOMAIN_PRINCIPLES = LOCKED
PRODUCT_SKU_INGREDIENT_RECIPE_BOUNDARY = LOCKED
PRODUCT_ACTIVATION_NOT_SELLABLE = LOCKED
FORMULA_GOVERNANCE = LOCKED
PRODUCT_IMPLEMENTATION_STATUS = PENDING
PRODUCT_SMOKE_STATUS = PENDING
PRODUCT_EVIDENCE_STATUS = PENDING
PRODUCT_RELEASE_READY = NO
PRODUCT_PRODUCTION_READY = NO
DOWNSTREAM_PRODUCT_DEPENDENCY = BLOCKED_UNTIL_PRODUCT_DOMAIN_CLEAR

KẾT THÚC PHẦN 1/4 — TECH-02 V1.0 CLEAN FINAL
...
Thì PHẦN 2/4 xác định rõ từng module phải làm gì, không được làm gì, phụ thuộc gì, cung cấp gì cho downstream và các P0 blocker nào phải chặn release.
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-PRODUCT-MASTER-001 |
| Module Name | Product Master Module |
| Source Pack | PACK-02 |
| Wave | Wave 1 |
| Application Group | Backend Core / Admin Web |
| Upstream | Foundation / RBAC / Audit |
| Downstream | SKU, Commerce, AI, Live, Ads, Public Trace |
| Default Status | PENDING_IMPLEMENTATION |
...
| Product Status | Ý nghĩa |
| --- | --- |
| DRAFT | Đang nháp |
| INTERNAL_REVIEW | Đang review nội bộ |
| APPROVED | Được duyệt master |
| ACTIVE | Được kích hoạt trong master |
| INACTIVE | Không còn active |
| RETIRED | Ngừng sử dụng |
| OWNER_REVIEW_REQUIRED | Cần owner quyết định |
| BLOCKED | Bị chặn do thiếu dữ liệu/P0 |
...
19.6. Product Master P0 Blocker
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-SKU-MASTER-001 |
| Module Name | SKU Master Module |
| Source Pack | PACK-02 |
| Wave | Wave 1 |
| Application Group | Backend Core / Admin Web |
| Upstream | Product Master, Foundation |
| Downstream | Recipe, Operational, Commerce, AI, Ads, Live, MISA if scope |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| --- | --- |
| DRAFT | Nháp |
| MASTER_READY | Dữ liệu master đủ |
| RECIPE_PENDING | Chưa đủ recipe/formula |
| KNOWLEDGE_PENDING | Chưa có product knowledge approved nếu AI/Live cần |
| ACTIVE | Được kích hoạt master |
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-INGREDIENT-MASTER-001 |
| Module Name | Ingredient Master Module |
| Source Pack | PACK-02 / PACK-03 |
| Wave | Wave 1 |
| Application Group | Backend Core / Admin Web |
| Upstream | Foundation |
| Downstream | Recipe, MRP, Operational, Procurement, Traceability |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| Raw Lot | Lô nguyên liệu cụ thể đã intake/QC/readiness |
| Supplier Mapping | Nhà cung cấp được phép cung cấp ingredient |
| Source Origin | Nguồn/vùng trồng nếu company source/self-grown |
| Inventory Balance | Tồn khả dụng theo lot/kho |
...
| Ingredient Status | Ý nghĩa |
| --- | --- |
| DRAFT | Nháp |
| ACTIVE | Được dùng trong recipe/MRP |
| INACTIVE | Không dùng |
| BLOCKED | Bị chặn |
| OWNER_REVIEW_REQUIRED | Cần owner quyết định |
| RETIRED | Ngừng sử dụng |
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-RECIPE-001 |
| Module Name | Recipe Module |
| Source Pack | PACK-02 / PACK-03 |
| Wave | Wave 1 |
| Application Group | Backend Core / Admin Web |
| Upstream | SKU Master, Ingredient Master, Foundation |
| Downstream | Formula Version, Operational, MRP, Production Snapshot |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| Recipe Status | Ý nghĩa |
| --- | --- |
| DRAFT | Nháp |
| UNDER_REVIEW | Đang review |
| APPROVED | Được duyệt |
| ACTIVE | Được dùng theo scope |
| RETIRED | Ngừng dùng |
| BLOCKED | Bị chặn |
| OWNER_REVIEW_REQUIRED | Cần owner quyết định |
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-FORMULA-VERSION-001 |
| Module Name | Formula Version Module |
| Source Pack | PACK-02 / PACK-03 |
| Wave | Wave 1 |
| Application Group | Backend Core / Admin Web |
| Upstream | Recipe Module, Foundation |
| Downstream | MRP, Production Order, Batch Traceability |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| Formula Version Status | Ý nghĩa |
| --- | --- |
| DRAFT | Nháp |
| UNDER_REVIEW | Đang review |
| APPROVED | Được duyệt |
| ACTIVE_OPERATIONAL | Được dùng operational theo scope |
| ACTIVE_PILOT | Được dùng pilot theo scope |
| RETIRED | Ngừng dùng |
| BLOCKED | Bị chặn |
| OWNER_REVIEW_REQUIRED | Cần owner quyết định |
...
23.8. Formula Version P0 Blocker
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-PRODUCT-ACTIVATION-001 |
| Module Name | Product Activation Module |
| Source Pack | PACK-02 / PACK-10 |
| Wave | Wave 1 |
| Application Group | Backend Core / Admin Web |
| Upstream | Product, SKU, Recipe, Formula, Product Knowledge, Foundation |
| Downstream | Commerce, AI, Live, Ads, Public Trace |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| Activation Scope | Ý nghĩa |
| --- | --- |
| INTERNAL_MASTER | Đủ master nội bộ |
| OPERATIONAL_READY | Đủ để dùng trong production planning |
| COMMERCE_CANDIDATE | Đủ điều kiện master để Commerce xem xét |
| AI_KNOWLEDGE_READY | Đủ knowledge approved để AI dùng |
| LIVE_SCOPE_READY | Đủ để đưa vào live scope |
| ADS_MEASUREMENT_READY | Đủ mapping để đo Ads |
| PUBLIC_TRACE_READY | Đủ public trace identity |
| FULL_PRODUCT_ACTIVE | Đủ master theo scope owner duyệt |
...
ACTIVE_SCOPE = YES/NO
SELLABLE = NOT_DECIDED_BY_THIS_MODULE
...
24.6. Product Activation P0 Blocker
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-PRODUCT-KNOWLEDGE-001 |
| Module Name | Product Knowledge Runtime Module |
| Source Pack | PACK-02 / PACK-06 |
| Wave | Wave 1 / Wave 4 dependency |
| Application Group | Backend Core / AI Runtime |
| Upstream | Product, SKU, Ingredient, Claim Guard, Foundation |
| Downstream | AI Advisor, Website, Landing Page, Messenger, Live, CRM if scope |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| Layer | Ý nghĩa |
| --- | --- |
| INTERNAL_PRODUCT_KNOWLEDGE | Dữ liệu nội bộ, source, formula summary, technical note |
| PUBLIC_PRODUCT_KNOWLEDGE | Nội dung được phép nói với khách |
| AI_RENDER_READY_KNOWLEDGE | Nội dung/biến được AI có thể render |
| LIVE_SCRIPT_READY_KNOWLEDGE | Nội dung được phép cue live |
| CLAIM_REVIEW_REQUIRED | Nội dung cần claim reviewer |
| BLOCKED_PUBLIC | Không được public |
...
25.7. Product Knowledge P0 Blocker
...
| Trường | Nội dung |
| --- | --- |
| Module Code | TECH-W1-PRODUCT-SCOPE-001 |
| Module Name | Product Scope Registry Module |
| Source Pack | PACK-02 / PACK-05 / PACK-06 / PACK-07 / PACK-08 |
| Wave | Wave 1 dependency for Wave 4–8 |
| Application Group | Backend Core / Channel Runtime |
| Upstream | Product/SKU/Activation/Sellable dependency |
| Downstream | Commerce, AI, Facebook, Ads, Live, Public Trace |
| Default Status | PENDING_IMPLEMENTATION |
| Production Status | NO |
...
| Scope Type | Ý nghĩa |
| --- | --- |
| COMMERCE_SCOPE | Được Commerce xem xét quote/order nếu sellable clear |
| AI_ADVISOR_SCOPE | Được AI tư vấn/render nếu knowledge approved |
| FACEBOOK_SCOPE | Được Gateway nhắc/handoff theo policy |
| ADS_MEASUREMENT_SCOPE | Được đo event/revenue mapping |
| ADS_SCALE_SCOPE | Được scale Ads nếu Data Quality/Revenue/Owner pass |
| LIVE_CUE_SCOPE | Được MC AI Live cue |
| PUBLIC_TRACE_SCOPE | Được public trace identity |
| LANDING_PAGE_SCOPE | Được hiển thị landing/page |
| CRM_SCOPE | Được dùng CRM nếu có |
| EXCLUDED_SCOPE | Loại khỏi scope hiện tại |
...
| Activate product | product.activate |
| Retire product | product.retire |
| Create SKU | sku.create |
| Update SKU | sku.update |
| Activate SKU | sku.activate |
...
| Approve recipe | recipe.approve |
| Activate formula | formula.activate |
| Retire formula | formula.retire |
| Approve product knowledge | product_knowledge.approve |
| Update product scope | product_scope.update |
| Approve production scope | product_scope.production_approve |
...
| --- | --- | --- |
| PROD-SMK-001 | Product ACTIVE nhưng không SKU | Không được Commerce quote |
| PROD-SMK-002 | SKU ACTIVE nhưng chưa sellable | Commerce/AI không được chốt bán |
| PROD-SMK-003 | Recipe draft | Không được production dùng |
| PROD-SMK-004 | Formula version mới active | Batch cũ không bị đổi lịch sử |
| PROD-SMK-005 | Product Knowledge chưa approved | AI/Live không được dùng |
| PROD-SMK-006 | Product Scope chưa Live approved | MC AI Live không cue |
| PROD-SMK-007 | Ingredient inactive | Recipe active không được dùng ingredient đó |
| PROD-SMK-008 | SKU sale lock | Commerce/AI/Ads/Live bị chặn |
| PROD-SMK-009 | Thêm SKU mới | Phải đi qua onboarding flow |
| PROD-SMK-010 | Scope production không owner decision | Bị chặn |
...
TECH_02_PART_2_GATE = FAILED
PRODUCT_MODULE_CONTRACT_GATE = BLOCKED
DOWNSTREAM_PRODUCT_SCOPE = BLOCKED
OWNER_REVIEW_REQUIRED = YES
...
P0 blocker Product phải chặn downstream.

Documentation Complete không phải Production Ready.

Trạng thái sau PHẦN 2/4:

TECH-02_PART_2 = DOCUMENTATION_COMPLETE
PRODUCT_MODULE_CONTRACTS = LOCKED
PRODUCT_MASTER_SPEC = LOCKED
SKU_MASTER_SPEC = LOCKED
INGREDIENT_MASTER_SPEC = LOCKED
RECIPE_SPEC = LOCKED
FORMULA_VERSION_SPEC = LOCKED
PRODUCT_ACTIVATION_SPEC = LOCKED
PRODUCT_KNOWLEDGE_SPEC = LOCKED
PRODUCT_SCOPE_SPEC = LOCKED
PRODUCT_IMPLEMENTATION_STATUS = PENDING
PRODUCT_SMOKE_STATUS = PENDING
PRODUCT_EVIDENCE_STATUS = PENDING
PRODUCT_RELEASE_READY = NO
...
KẾT THÚC PHẦN 2/4 — TECH-02 V1.0 CLEAN FINAL
...
Khi nào downstream bị BLOCKED.

Khi nào owner phải review.

Khi nào Product domain được Release Ready.

Khi nào Product domain vẫn phải giữ PENDING_EVIDENCE / BLOCKED.
...
| Product State | Ý nghĩa |
| --- | --- |
| DRAFT | Product mới tạo, chưa đủ dữ liệu |
| INTERNAL_REVIEW | Đang review nội bộ |
| APPROVED | Product master đã được duyệt |
| ACTIVE | Product được kích hoạt ở master |
| SCOPE_CONFIGURED | Đã cấu hình scope sử dụng |
| RELEASE_CANDIDATE | Đủ điều kiện trình release theo scope |
| RELEASED_FOR_SCOPE | Đã được owner/release decision cho scope cụ thể |
| INACTIVE | Tạm không dùng |
| RETIRED | Ngừng sử dụng |
| BLOCKED | Bị chặn do P0 hoặc thiếu dữ liệu |
| OWNER_REVIEW_REQUIRED | Cần owner quyết định |
...
| From State | To State | Điều kiện |
| --- | --- | --- |
| DRAFT | INTERNAL_REVIEW | Đủ dữ liệu tối thiểu |
| INTERNAL_REVIEW | APPROVED | Reviewer/owner duyệt master |
| APPROVED | ACTIVE | Product đủ master, audit, permission |
| ACTIVE | SCOPE_CONFIGURED | Có scope theo kênh/module |
| SCOPE_CONFIGURED | RELEASE_CANDIDATE | Có evidence/smoke liên quan scope |
| RELEASE_CANDIDATE | RELEASED_FOR_SCOPE | Owner release decision |
| ACTIVE | INACTIVE | Owner/permission hợp lệ |
| ACTIVE / INACTIVE | RETIRED | Có owner decision nếu đã từng production |
| Any | BLOCKED | Có P0 blocker |
| Any | OWNER_REVIEW_REQUIRED | Có conflict/dependency chưa rõ |
...
Product BLOCKED vẫn xuất hiện trong AI/Live/Commerce.
...
| SKU State | Ý nghĩa |
| --- | --- |
| DRAFT | SKU mới, thiếu dữ liệu |
| MASTER_READY | SKU đủ master data |
| RECIPE_REQUIRED | SKU cần recipe/formula nhưng chưa đủ |
| RECIPE_READY | Recipe/formula đã đủ theo scope |
| KNOWLEDGE_REQUIRED | SKU cần knowledge để AI/Live/Public dùng |
| KNOWLEDGE_READY | Product knowledge đã approved |
| SCOPE_PENDING | Chưa được gán scope |
| ACTIVE | SKU active ở master |
| RELEASE_CANDIDATE | Đủ điều kiện trình release theo scope |
| RELEASED_FOR_SCOPE | Được release cho scope cụ thể |
| INACTIVE | Không active |
| RETIRED | Ngừng dùng |
| BLOCKED | Bị chặn |
| OWNER_REVIEW_REQUIRED | Cần owner quyết định |
...
| Scope | Dependency |
| --- | --- |
| COMMERCE_SCOPE | SKU active, price runtime, sellable dependency |
| AI_ADVISOR_SCOPE | Product knowledge approved, claim guard |
| FACEBOOK_SCOPE | AI/Commerce boundary nếu có handoff |
| ADS_MEASUREMENT_SCOPE | SKU/order/revenue mapping |
| ADS_SCALE_SCOPE | Data quality, verified revenue, sellable/fulfillment |
| LIVE_CUE_SCOPE | Product knowledge, live script, claim guard, sellable |
| PUBLIC_TRACE_SCOPE | Public identity, trace whitelist |
| CRM_SCOPE | Product knowledge, customer memory policy |
| IVR_SCOPE | Order product naming, no sales behavior |
...
| Consumer | Runtime View |
| --- | --- |
| Operational | SKU + active formula + ingredient recipe snapshot source |
| MRP | SKU + formula + ingredient/UOM/scaling basis |
| Commerce | SKU identity + activation/sellable dependency + public name |
| AI Advisor | Product knowledge public-safe + resolver variables |
| Facebook Gateway | Product public name + safe handoff metadata |
| Ads Measurement | SKU/product mapping + campaign product scope |
| MC AI Live | Product scope + live script ready knowledge |
| Public Trace | Public identity + whitelist fields |
| MISA/Accounting | SKU/material mapping if scope |
...
Kết quả phải là BLOCKED / OWNER_REVIEW_REQUIRED / DATA_UNAVAILABLE theo scope.
...
Product unavailable reason nếu blocked.
...
| Downstream | Câu hỏi |
| --- | --- |
| Operational | Có ảnh hưởng production order/batch không? |
| MRP | Có ảnh hưởng BOM/procurement không? |
| Commerce | Có ảnh hưởng quote/order không? |
| AI | Có ảnh hưởng câu tư vấn không? |
| Facebook | Có ảnh hưởng public/private reply không? |
| Ads | Có ảnh hưởng attribution/revenue mapping không? |
| Live | Có ảnh hưởng script/cue không? |
| Public Trace | Có ảnh hưởng public fields không? |
| MISA | Có ảnh hưởng mapping kế toán không? |
| Evidence/Release | Có cần retest/release lại không? |
...
| Consumer | Behavior |
| --- | --- |
| AI | Không tư vấn/chốt SKU, trả safe fallback hoặc handoff |
| Commerce | Không quote/order SKU |
| Live | Không cue SKU |
| Ads | Không scale/report official theo SKU đó |
| Public Trace | Không public |
| Operational | Không production theo formula thiếu |
| MRP | Không tính BOM thiếu |
...
| Scope | Status |
| --- | --- |
| Master | NOT_STARTED / SPEC_COMPLETE / ACTIVE |
| Operational | BLOCKED / READY / RELEASED |
| Commerce | BLOCKED / RELEASE_CANDIDATE / RELEASED |
| AI | BLOCKED / KNOWLEDGE_READY / RELEASED |
| Facebook | BLOCKED / SCOPE_READY / RELEASED |
| Ads Measurement | BLOCKED / MAPPED / RELEASED |
| Ads Scale | BLOCKED / OWNER_REVIEW_REQUIRED / RELEASED |
| Live | BLOCKED / SCRIPT_READY / RELEASED |
| Public Trace | BLOCKED / WHITELIST_READY / RELEASED |
...
TECH_02_PART_3_GATE = FAILED
PRODUCT_LIFECYCLE_GATE = BLOCKED
PRODUCT_RUNTIME_GATE = BLOCKED
DOWNSTREAM_PRODUCT_SCOPE = BLOCKED
OWNER_REVIEW_REQUIRED = YES
...
TECH-02_PART_3 = DOCUMENTATION_COMPLETE
PRODUCT_LIFECYCLE_MODEL = LOCKED
SKU_LIFECYCLE_MODEL = LOCKED
RECIPE_FORMULA_LIFECYCLE = LOCKED
PRODUCT_COMMAND_QUERY_BOUNDARY = LOCKED
PRODUCT_RUNTIME_HANDOFF = LOCKED
PRODUCT_RELEASE_STATUS_BY_SCOPE = LOCKED
PRODUCT_IMPLEMENTATION_STATUS = PENDING
PRODUCT_SMOKE_STATUS = PENDING
PRODUCT_EVIDENCE_STATUS = PENDING
PRODUCT_RELEASE_READY = NO
...
KẾT THÚC PHẦN 3/4 — TECH-02 V1.0 CLEAN FINAL
...
Downstream bị BLOCKED khi Product domain chưa clear.



54.2. Smoke phải test cả blocked path
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| PROD-MST-SMK-001 | Tạo product draft | Product ở trạng thái DRAFT, chưa downstream production |
| PROD-MST-SMK-002 | Product thiếu public name approved | AI/Live/Public không được dùng |
| PROD-MST-SMK-003 | Product APPROVED → ACTIVE | Có permission, guard, audit |
| PROD-MST-SMK-004 | Product ACTIVE nhưng chưa scope | Downstream Commerce/AI/Live/Ads bị blocked |
| PROD-MST-SMK-005 | Product RETIRED | Không được quote/order/cue live/scale ads |
| PROD-MST-SMK-006 | Product BLOCKED | Downstream sales scope blocked |
| PROD-MST-SMK-007 | Product status change | Audit created |
| PROD-MST-SMK-008 | Product legacy chưa review | OWNER_REVIEW_REQUIRED |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| SKU-SMK-001 | SKU tạo mới | SKU ở trạng thái DRAFT |
| SKU-SMK-002 | SKU không có product mapping | Không được active |
| SKU-SMK-003 | SKU thiếu recipe required | Không được operational/production scope |
| SKU-SMK-004 | SKU thiếu product knowledge | Không được AI/Live scope |
| SKU-SMK-005 | SKU ACTIVE nhưng chưa sellable | Commerce/AI không được chốt bán |
| SKU-SMK-006 | SKU RETIRED | Không xuất hiện production scope |
| SKU-SMK-007 | SKU public name chưa approved | Không render với khách |
| SKU-SMK-008 | SKU thêm mới ngoài baseline | Phải qua onboarding + owner decision |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| ING-SMK-001 | Tạo ingredient active | Ingredient có mã, nhóm, UOM, audit |
| ING-SMK-002 | Ingredient inactive dùng trong recipe active | Blocked |
| ING-SMK-003 | Ingredient lot-managed nhưng thiếu lot policy | Blocked for operational use |
| ING-SMK-004 | Ingredient company source bị dùng như purchased trái rule | Blocked / Owner Review |
| ING-SMK-005 | Ingredient QC required nhưng intake bỏ qua | Blocked downstream |
| ING-SMK-006 | Ingredient UOM thay đổi | Impact review required |
| ING-SMK-007 | Ingredient thay thế trong recipe active | New formula version required |
| ING-SMK-008 | Ingredient public leak supplier/costing | Blocked |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| RCP-SMK-001 | Recipe draft | Không được production dùng |
| RCP-SMK-002 | Recipe thiếu line group | Validation failed |
| RCP-SMK-003 | Recipe line group ngoài 4 group khóa | Blocked unless owner decision |
| RCP-SMK-004 | Recipe thiếu ingredient/quantity/UOM | Validation failed |
| RCP-SMK-005 | Recipe dùng ingredient inactive | Blocked |
| RCP-SMK-006 | Recipe approved | Audit created |
| RCP-SMK-007 | Recipe active for production | Owner decision required |
| RCP-SMK-008 | Recipe active đã dùng production bị sửa | Blocked; new version required |
| RCP-SMK-009 | Recipe public leak formula detail | Blocked |
| RCP-SMK-010 | Recipe used by Production Order | Snapshot required |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| FML-SMK-001 | Tạo formula version mới | Version mới không ghi đè version cũ |
| FML-SMK-002 | Activate formula pilot | ACTIVE_PILOT only |
| FML-SMK-003 | Activate formula operational | Owner decision + audit required |
| FML-SMK-004 | Forbidden formula kind/token operational | Blocked |
| FML-SMK-005 | G1/G2 conflict | Owner review / blocked |
| FML-SMK-006 | Production Order dùng formula | Snapshot kind/version |
| FML-SMK-007 | Batch trace formula | Truy được formula version |
| FML-SMK-008 | Retire formula used in history | History preserved |
| FML-SMK-009 | Formula activation without audit | Fail |
| FML-SMK-010 | MRP reads wrong formula kind | Blocked |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| ACT-SMK-001 | Product master approved | Có thể xét activation, chưa sellable |
| ACT-SMK-002 | SKU active nhưng chưa price/stock/batch | Not sellable |
| ACT-SMK-003 | AI Knowledge chưa approved | AI scope blocked |
| ACT-SMK-004 | Live scope chưa approved | Live cue blocked |
| ACT-SMK-005 | Ads measurement mapping thiếu | Ads official mapping blocked |
| ACT-SMK-006 | Product active flag dùng thay all scope | Fail |
| ACT-SMK-007 | Activation production không owner decision | Blocked |
| ACT-SMK-008 | Activation status change | Audit created |
| ACT-SMK-009 | P0 blocker open | Activation blocked |
| ACT-SMK-010 | Scope excluded | Downstream must respect excluded scope |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| PK-SMK-001 | Knowledge draft | AI/Live/Public blocked |
| PK-SMK-002 | Public-safe approved | AI can use within scope |
| PK-SMK-003 | Claim review required | AI/Live blocked until review |
| PK-SMK-004 | Claim vượt whitelist | Rejected |
| PK-SMK-005 | Content nói như thuốc | Rejected |
| PK-SMK-006 | Content lộ công thức/cost/supplier/internal | Rejected |
| PK-SMK-007 | Knowledge superseded | Old version not used production |
| PK-SMK-008 | Knowledge version missing | Rejected |
| PK-SMK-009 | AI query internal knowledge for public render | Blocked |
| PK-SMK-010 | Knowledge approval | Audit created |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| PSC-SMK-001 | Add SKU to Commerce Scope | Requires activation + sellable dependency |
| PSC-SMK-002 | Add SKU to AI Scope | Requires knowledge approved |
| PSC-SMK-003 | Add SKU to Live Scope | Requires live-safe knowledge + owner decision |
| PSC-SMK-004 | Add SKU to Ads Scale Scope | Requires data quality/verified revenue/owner decision |
| PSC-SMK-005 | Sale lock active | SKU removed/blocked from sales scope |
| PSC-SMK-006 | Recall active | SKU/batch sales scope blocked |
| PSC-SMK-007 | Scope changed | Audit created |
| PSC-SMK-008 | Scope production without evidence | Blocked |
| PSC-SMK-009 | One flag used for all scopes | Fail |
| PSC-SMK-010 | Excluded scope | Downstream must block usage |
...
| Smoke ID | Scenario | Expected Result |
| --- | --- | --- |
| DSH-SMK-001 | Product → Operational | SKU + active formula + recipe snapshot source available |
| DSH-SMK-002 | Product → MRP | BOM/ingredient/UOM/formula kind available |
| DSH-SMK-003 | Product → Commerce | SKU identity + activation + sellable dependency available |
| DSH-SMK-004 | Product → AI | AI_RENDER_READY knowledge only |
| DSH-SMK-005 | Product → Facebook | Channel-safe public metadata only |
| DSH-SMK-006 | Product → Ads | SKU/product/order/revenue mapping reference |
| DSH-SMK-007 | Product → MC AI Live | Live Product Scope + script-ready knowledge |
| DSH-SMK-008 | Product → Public Trace | Whitelist public identity only |
| DSH-SMK-009 | Runtime unavailable | Downstream blocked, no fake data |
| DSH-SMK-010 | Product P0 open | Downstream product dependency blocked |
...
| --- | --- |
| EV-PROD-MASTER | Product Master evidence |
| EV-SKU-MASTER | SKU Master evidence |
| EV-ING-MASTER | Ingredient Master evidence |
| EV-RECIPE | Recipe validation/version evidence |
| EV-FORMULA | Formula version/coexistence evidence |
| EV-ACTIVATION | Product/SKU activation evidence |
| EV-KNOWLEDGE | Product Knowledge approval evidence |
| EV-SCOPE | Product Scope Registry evidence |
| EV-HANDOFF | Downstream runtime handoff evidence |
| EV-PERMISSION | Permission/audit evidence for Product actions |
| EV-P0 | Product P0 blocker fix/retest evidence |
| EV-OWNER | Owner decision evidence |
| EV-SECURITY | Public/internal data boundary evidence |
...
| --- | --- |
| EV-PROD-MASTER | Product có lifecycle, public name approved, status audit |
| EV-SKU-MASTER | SKU mapping đúng product, active chưa bị hiểu là sellable |
| EV-ING-MASTER | Ingredient có group/UOM/lot/source/QC flags đúng |
| EV-RECIPE | Recipe đủ group/ingredient/quantity/UOM/version |
| EV-FORMULA | Formula không ghi đè lịch sử, snapshot được |
| EV-ACTIVATION | Activation theo scope, không thay sellable |
| EV-KNOWLEDGE | AI/Live/Public chỉ dùng approved knowledge |
| EV-SCOPE | Commerce/AI/Ads/Live/Public scope tách rõ |
| EV-HANDOFF | Downstream nhận đúng runtime view |
| EV-OWNER | Production scope có owner decision |
...
| --- | --- |
| Product Module Map | Có |
| Product Master Spec | Có |
| SKU Master Spec | Có |
| Ingredient Master Spec | Có |
| Recipe Spec | Có |
| Formula Version Spec | Có |
| Product Activation Spec | Có |
| Product Knowledge Spec | Có |
| Product Scope Spec | Có |
| Future SKU Onboarding Spec | Có |
| Product Command Boundary | Có |
| Product Query Boundary | Có |
| Product Runtime/Handoff Map | Có |
| Product Permission Matrix | Có |
| Product Audit Plan | Có |
| Product P0 Blocker Baseline | Có |
| Product Smoke Plan | Có |
| Product Evidence Package Plan | Có |
| Product Owner Review Questions | Có |
| Product Downstream Dependency Report | Có |
...
TECH_03_OPERATIONAL_PRODUCT_DEPENDENCY = BLOCKED
TECH_04_COMMERCE_PRODUCT_DEPENDENCY = BLOCKED
TECH_05_AI_PRODUCT_DEPENDENCY = BLOCKED
TECH_07_ADS_PRODUCT_DEPENDENCY = BLOCKED
TECH_08_LIVE_PRODUCT_DEPENDENCY = BLOCKED
...
| --- | --- | --- |
| Product Master | Product inactive/retired vẫn downstream | Product scope blocked |
| SKU Master | SKU active hiểu là sellable | Commerce/AI blocked |
| Ingredient | Ingredient inactive dùng trong active recipe | Recipe/MRP blocked |
| Recipe | Recipe draft/invalid dùng production | Operational blocked |
| Formula | Formula version overwrite | Trace/history invalid |
| Activation | One flag active for all scopes | Release blocked |
| Knowledge | Unapproved knowledge used public | AI/Live/Public blocked |
| Scope | No channel-specific scope | Downstream blocked |
| Handoff | Runtime unavailable but downstream proceeds | P0 |
| Evidence | No accepted evidence | Release blocked |
...
| Mục | Nội dung |
| --- | --- |
| Product Release Package ID | Mã gói |
| Scope | Product/SKU/channel/scope được xét |
| Source Documents | MASTER/PACK/TECH liên quan |
| Product List | Product trong scope |
| SKU List | SKU trong scope |
| Ingredient Impact | Ingredient liên quan |
| Recipe / Formula Summary | Formula kind/version trong scope |
| Product Knowledge Status | Approved / pending / blocked |
| Product Scope Status | Commerce/AI/Ads/Live/Public |
| Activation Status | Active by scope |
| Sellable Dependency Note | Product active chưa phải sellable |
| Downstream Handoff Summary | Operational/Commerce/AI/Ads/Live |
| Smoke Summary | Kết quả smoke |
| Evidence List | Evidence liên quan |
| P0 Blocker Status | OPEN / CLEARED |
| Owner Questions | Các điểm cần quyết |
| Excluded Scope | Scope chưa release |
| Risk Register | Rủi ro |
| Proposed Status | BLOCKED / OWNER_REVIEW_REQUIRED / RELEASE_READY |
...
OPERATIONAL_PRODUCT_DEPENDENCY = BLOCKED
...
COMMERCE_PRODUCT_DEPENDENCY = BLOCKED
...
ADS_PRODUCT_DEPENDENCY = BLOCKED
...
LIVE_PRODUCT_DEPENDENCY = BLOCKED
...
PUBLIC_TRACE_PRODUCT_DEPENDENCY = BLOCKED
...
Product P0 blocker created/reopened.

Downstream request blocked due to product dependency.

AI attempted to use unapproved knowledge.

Live attempted to cue out-of-scope SKU.

Commerce attempted to quote blocked SKU.

Ads attempted to scale blocked SKU.
...
66. TECH-02 FINAL STATUS

Sau khi TECH-02 hoàn tất tài liệu, trạng thái đúng là:

| Status Group | Value |
| --- | --- |
| TECH-02_DOCUMENTATION_STATUS | COMPLETE |
| PRODUCT_SPEC_STATUS | COMPLETE |
| SKU_SPEC_STATUS | COMPLETE |
| INGREDIENT_SPEC_STATUS | COMPLETE |
| RECIPE_SPEC_STATUS | COMPLETE |
| FORMULA_VERSION_SPEC_STATUS | COMPLETE |
| PRODUCT_ACTIVATION_SPEC_STATUS | COMPLETE |
| PRODUCT_KNOWLEDGE_SPEC_STATUS | COMPLETE |
| PRODUCT_SCOPE_SPEC_STATUS | COMPLETE |
| PRODUCT_IMPLEMENTATION_STATUS | PENDING |
| PRODUCT_TEST_STATUS | PENDING |
| PRODUCT_SMOKE_STATUS | PENDING |
| PRODUCT_EVIDENCE_STATUS | PENDING |
| PRODUCT_RELEASE_READY | NO |
| PRODUCT_RELEASE_APPROVED | NO |
| PRODUCT_PRODUCTION_READY | NO |
| DOWNSTREAM_PRODUCT_DEPENDENCY | BLOCKED_UNTIL_PRODUCT_DOMAIN_CLEAR |
| GO_LIVE_APPROVED | NO |
...
TECH-02 — PRODUCT / SKU / INGREDIENT / RECIPE / FORMULA / PRODUCT ACTIVATION — V1.0 CLEAN FINAL đã khóa lớp kỹ thuật sản phẩm nền cho hệ thống Ginsengfood.
...
Downstream production bị BLOCKED nếu Product domain chưa clear.
...
TECH-02 = DOCUMENTATION_COMPLETE
PRODUCT_TECHNICAL_SPEC = LOCKED
PRODUCT_IMPLEMENTATION_STATUS = PENDING
PRODUCT_TEST_STATUS = PENDING
PRODUCT_SMOKE_STATUS = PENDING
PRODUCT_EVIDENCE_STATUS = PENDING
