...
- PACK-05 AI Advisor Channel consultation boundary.
- TECH-05 Product Consulting va Safe Sales Handoff.
- PACK-02 Product Master / SKU / Recipe / Activation.
- PACK-01 Sellable, Recall va Sale Lock guard.
...
File: 04-P4-2C-PRODUCT-KNOWLEDGE-CONSULTATION-ORCHESTRATOR.docx
...
## 00-P4-ANALYSIS-ONLY đã hoàn tất report phân tích hoặc có kết quả current state đủ để triển khai có kiểm soát.

## 01-P4-1-TECHNICAL-DESIGN-ONLY đã khóa boundary tổng thể của AI Advisor Runtime.

## 02-P4-2A-RUNTIME-CONSUMER-CONTRACT đã xác định AI Advisor nhận runtime data theo hợp đồng nào.

## 03-P4-2B-CUSTOMER-MEMORY-CONTEXT-RESOLVER đã khóa Customer Memory và Context Resolver theo read-only consumer view.
...
Smoke P4-2C-SMK-001 đến P4-2C-SMK-010 pass hoặc có lý do block được owner chấp nhận.
...
## 9. Viết tests và smoke P4-2C-SMK-001 đến P4-2C-SMK-010.
...
## 05-P4-2D-QUOTE-ORDER-DRAFT-CONFIRMATION-CONSUMER
