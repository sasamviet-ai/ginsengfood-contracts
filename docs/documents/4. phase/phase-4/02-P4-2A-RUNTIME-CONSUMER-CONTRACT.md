...
- TECH-05 AI Advisor Runtime consumer boundary.
- TECH-04 Commerce Runtime owner boundary.
- PHASE-01, PHASE-02 va PHASE-03 la upstream truth owner.
- AI Advisor khong tu tinh gia, ton, sellable, order, paid, revenue, commission, ROAS hoac payout.
...
File: 02-P4-2A-RUNTIME-CONSUMER-CONTRACT.docx
...
## 00-P4-ANALYSIS-ONLY.docx đã được chạy hoặc ít nhất đã được developer đọc và lập current state/gap/điểm chặn report.

## 01-P4-1-TECHNICAL-DESIGN-ONLY.docx đã được dùng làm thiết kế định hướng cho Phase 4.
...
File tiếp theo: 03-P4-2B-CUSTOMER-MEMORY-CONTEXT-RESOLVER.docx; Điều kiện nhận handoff: P4-2A xác định rõ contract customer_context/customer_memory và privacy boundary.; Nội dung chuyển tiếp: Thiết kế/triển khai sâu Customer Memory, member context, preference, recipient, consent, fatigue.

File tiếp theo: 04-P4-2C-PRODUCT-KNOWLEDGE-CONSULTATION-ORCHESTRATOR.docx; Điều kiện nhận handoff: P4-2A xác định ProductPublicData và SellableRuntime consumer contract.; Nội dung chuyển tiếp: Thiết kế orchestrator chọn SKU/combo dựa trên product knowledge + sellable + guard.

File tiếp theo: 05-P4-2D-QUOTE-ORDER-DRAFT-CONFIRMATION-CONSUMER.docx; Điều kiện nhận handoff: P4-2A xác định QuoteSnapshot/OrderDraft/OfficialOrder/Payment boundary.; Nội dung chuyển tiếp: Đi sâu quote, order draft, confirmation, order_code, payment/shipping public state.

File tiếp theo: 06-P4-2E-SAFETY-PUBLIC-WORDING-CLAIM-GUARD.docx; Điều kiện nhận handoff: P4-2A xác định public/private field và claim-risk boundary.; Nội dung chuyển tiếp: Khóa wording guard, health-sensitive, claim whitelist, internal leak prevention.

File tiếp theo: 07-P4-2F-CHANNEL-HANDOFF-MESSENGER-LIVE-CRM-BRIDGE.docx; Điều kiện nhận handoff: P4-2A xác định ChannelPolicyConsumer và private handoff rule.; Nội dung chuyển tiếp: Đi sâu live/comment/Messenger/CRM bridge và anti-spam/fatigue/abuse policy.
...
Bạn đang triển khai PHASE-04-AI-ADVISOR-RUNTIME, file 02-P4-2A-RUNTIME-CONSUMER-CONTRACT.
...
## 03-P4-2B-CUSTOMER-MEMORY-CONTEXT-RESOLVER
