...
- TECH-05 AI Advisor quote va order draft consumer.
- TECH-04 Commerce Runtime QuoteSnapshot va Official Order owner.
- PHASE-03 P3.2B, P3.2C va P3.2D.
...
File: 05-P4-2D-QUOTE-ORDER-DRAFT-CONFIRMATION-CONSUMER.docx
...
File tiếp theo: 06-P4-2E-SAFETY-PUBLIC-WORDING-CLAIM-GUARD.docx; Nhận từ P4-2D: Các template quote/order/payment/shipping customer-facing cần được đưa qua claim guard và public/private guard.; Yêu cầu giữ nguyên: Không nói quá claim, không lộ nội bộ, không dùng "hệ thống" trong câu trả lời khách, không làm mất lực bán.

File tiếp theo: 07-P4-2F-CHANNEL-HANDOFF-MESSENGER-LIVE-CRM-BRIDGE.docx; Nhận từ P4-2D: Order Draft/Quote flow phải phân biệt public comment, Messenger/private, CRM follow-up, website/admin UI.; Yêu cầu giữ nguyên: Giá/quote/order ưu tiên private; public không thu thập thông tin cá nhân.
...
Bạn đang triển khai PHASE-04-AI-ADVISOR-RUNTIME, file 05-P4-2D-QUOTE-ORDER-DRAFT-CONFIRMATION-CONSUMER.docx.
...
## 06-P4-2E-SAFETY-PUBLIC-WORDING-CLAIM-GUARD
