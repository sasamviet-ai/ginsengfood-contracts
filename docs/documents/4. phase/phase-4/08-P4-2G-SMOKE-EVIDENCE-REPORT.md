...
- P4.2A den P4.2F reports va evidence.
- AI Advisor local smoke khong dong nghia release hoac go-live decision.
...
File: 08-P4-2G-SMOKE-EVIDENCE-REPORT.docx
...
Nguồn: 00-P4-ANALYSIS-ONLY; Vai trò trong smoke 2G: Baseline current state, gap, conflict, điểm chặn.; Điểm bắt buộc phải chứng minh: Report phải xác nhận điểm chặn từ analysis đã được xử lý hoặc còn mở.

Nguồn: 01-P4-1-TECHNICAL-DESIGN-ONLY; Vai trò trong smoke 2G: Thiết kế tổng thể AI Advisor Runtime.; Điểm bắt buộc phải chứng minh: Implementation phải khớp design boundary: AI là consumer/orchestrator, không phải owner business truth.

Nguồn: 02-P4-2A-RUNTIME-CONSUMER-CONTRACT; Vai trò trong smoke 2G: Contract consume Phase 1/2/3 runtime.; Điểm bắt buộc phải chứng minh: Không có logic tự tính giá, tồn, sellable, order, paid, revenue trong AI Advisor.

Nguồn: 03-P4-2B-CUSTOMER-MEMORY-CONTEXT-RESOLVER; Vai trò trong smoke 2G: Customer memory và context resolver read-only.; Điểm bắt buộc phải chứng minh: AI dùng memory để tư vấn, không tự quyết quyền lợi giá/tồn/trạng thái đơn.

Nguồn: 04-P4-2C-PRODUCT-KNOWLEDGE-CONSULTATION-ORCHESTRATOR; Vai trò trong smoke 2G: Tư vấn sản phẩm theo product knowledge và sellable runtime.; Điểm bắt buộc phải chứng minh: Không tư vấn/chốt SKU bị not sellable, recall, sale lock, không phù hợp dietary/allergy.

Nguồn: 05-P4-2D-QUOTE-ORDER-DRAFT-CONFIRMATION-CONSUMER; Vai trò trong smoke 2G: QuoteSnapshot, Order Draft, Customer Confirmation consumer.; Điểm bắt buộc phải chứng minh: Không có QuoteSnapshot thì không final price; không có order_code thì không đơn chính thức; selected payment không phải Paid.

Nguồn: 06-P4-2E-SAFETY-PUBLIC-WORDING-CLAIM-GUARD; Vai trò trong smoke 2G: Public wording, claim guard, leak guard.; Điểm bắt buộc phải chứng minh: Không nói chữa bệnh, không lộ internal data, không dùng internal SKU code với khách, không mất lực bán.

Nguồn: 07-P4-2F-CHANNEL-HANDOFF-MESSENGER-LIVE-CRM-BRIDGE; Vai trò trong smoke 2G: Messenger/Live/CRM handoff bridge.; Điểm bắt buộc phải chứng minh: Public/private boundary đúng; CRM/Live tôn trọng sellable, recall/sale lock, opt-out và policy.
...
PASS cục bộ, evidence đủ: Chuyển sang README-PHASE-04-HANDOFF-INDEX để đóng gói Phase 4 và đưa owner review. Gateway vẫn bị chặn.
