...
- PHASE-03 Commerce Runtime la owner cua sellable, quote, order va payment state.
...
Chỉ khi report P4 Analysis được owner đọc và chấp nhận, mới được tạo file tiếp theo: 01-P4-1-TECHNICAL-DESIGN-ONLY.docx. Nếu còn điểm chặn critical, không được chuyển sang thiết kế chi tiết mà phải yêu cầu owner quyết định hướng xử lý hoặc quay lại chỉnh tài liệu source-of-truth nếu phát hiện mâu thuẫn tài liệu.
