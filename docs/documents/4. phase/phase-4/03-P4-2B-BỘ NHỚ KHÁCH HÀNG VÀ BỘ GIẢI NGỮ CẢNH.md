...
Trạng thái mặc định của file này: CUSTOMER_MEMORY_CONTEXT_LOCK_WITH_IMPORTED_SOURCE. Evidence tối thiểu phải có input context, source class, privacy classification, suppression result, resolver trace, guard result và masked PII status. Không được gọi IMPLEMENTATION_READY, GATEWAY_PASS, COMPLETION_PASS, RELEASE_READY, PRODUCTION_READY hoặc GO_LIVE_APPROVED.
...
File: 03-P4-2B-BỘ NHỚ KHÁCH HÀNG VÀ BỘ GIẢI NGỮ CẢNH.docx
...
## 02-P4-2A-HỢP ĐỒNG TIÊU THỤ DỮ LIỆU THỜI GIAN CHẠY đã khóa AI Advisor là runtime consumer, không phải owner business truth.
...
Downstream file: 04-P4-2C-ĐIỀU PHỐI TƯ VẤN KIẾN THỨC SẢN PHẨM; P4-2B bàn giao: customer_need, recipient_profile, dietary_guard, taste_preference, member_context read-only, suppression_context, context_status.; Downstream không được làm: Không dùng memory để bypass sellable/recall/sale lock.

Downstream file: 05-P4-2D-TIÊU THỤ BÁO GIÁ NHÁP VÀ XÁC NHẬN ĐƠN; P4-2B bàn giao: identity confidence, old_info_available, communication channel, order context refs nếu có.; Downstream không được làm: Không dùng memory để tự tạo order_code hoặc tự xác nhận paid.

Downstream file: 06-P4-2E-CHẶN AN TOÀN NGÔN TỪ CÔNG KHAI VÀ TUYÊN BỐ; P4-2B bàn giao: health_sensitive_signal, privacy class, public/private flags.; Downstream không được làm: Không biến customer memory thành claim y tế hoặc expose PII.

Downstream file: 07-P4-2F-CẦU NỐI BÀN GIAO KÊNH MESSENGER LIVE CRM; P4-2B bàn giao: channel context, do_not_contact, fatigue, private/public mode, handoff flag.; Downstream không được làm: Không gửi CRM/proactive message khi suppressed.
...
## 04-P4-2C-ĐIỀU PHỐI TƯ VẤN KIẾN THỨC SẢN PHẨM
