...
Mục tiêu: khóa nguồn sự thật Phase 1 sau khi hấp thụ đủ 5 file nguồn cũ. File này là điểm đọc đầu tiên của Phase 1; không dùng bảng gôm.
...
| --- | --- | --- |
| 00 | `00-P1-PHÂN TÍCH NGUỒN SỰ THẬT VÀ PHẠM VI.md` | Phân tích nguồn, phạm vi, conflict normalization |
| 01 | `01-P1-THIẾT KẾ KỸ THUẬT SẢN PHẨM SKU CÔNG THỨC.md` | Thiết kế kỹ thuật Phase 1 |
| 02 | `02-P1-SẢN PHẨM SKU NGUYÊN LIỆU ĐƠN VỊ TÍNH.md` | Product/SKU/material/UOM master |
| 03 | `03-P1-CÔNG THỨC BOM PHIÊN BẢN G1.md` | Recipe/BOM/Formula G1 và nguồn công thức |
| 04 | `04-P1-KHÓA KÍCH HOẠT SẢN PHẨM.md` | Activation guard và downstream boundary |
| 05 | `05-P1-QUẢN TRỊ SEED MỞ RỘNG SKU VÀ VẬT TƯ.md` | Seed/extension/material/packaging/threshold governance |
| 06 | `06-P1-SMOKE BẰNG CHỨNG VÀ NGHIỆM THU.md` | Smoke/evidence/coverage |

## 7. Nơi lưu nguồn gốc sau khi bỏ 5 file rời

| File nguồn cũ | File Phase 1/2 giữ payload nguyên văn | Rule canonical đã rút ra |
| --- | --- | --- |
| `BẢNG PHIẾU LỆNH SẢN XUẤT.md` | `03-P2-LỆNH SẢN XUẤT HỒ SƠ GỐC VÀ SNAPSHOT.md` | Phase 1 phải cung cấp SKU/formula/material/UOM đủ để lệnh sản xuất tự hiện công thức |
| `BỘ KHÓA 5 BƯỚC.md` | `03-P1-CÔNG THỨC BOM PHIÊN BẢN G1.md`, `06-P2-TRUY XUẤT QR THU HỒI VÀ KHÓA BÁN.md` | BOM map, version, không chọn tay nguyên liệu, trace/recall boundary |
| `CÔNG THỨC VẬN HÀNH 20 SKU MỚI.MD` | `02-P1-SẢN PHẨM SKU NGUYÊN LIỆU ĐƠN VỊ TÍNH.md`, `03-P1-CÔNG THỨC BOM PHIÊN BẢN G1.md`, `03-P2-LỆNH SẢN XUẤT HỒ SƠ GỐC VÀ SNAPSHOT.md` | 20 SKU G1, định lượng từng nguyên liệu, ratio, sơ chế |
| `DANH MỤC PHÂN NHÓM NGUYÊN LIỆU VẬT TƯ.md` | `02-P1-SẢN PHẨM SKU NGUYÊN LIỆU ĐƠN VỊ TÍNH.md`, `05-P1-QUẢN TRỊ SEED MỞ RỘNG SKU VÀ VẬT TƯ.md`, `02-P2-NGUỒN NGUYÊN LIỆU LÔ QC SẴN SÀNG SẢN XUẤT.md` | Material/packaging groups, thresholds, procurement suppression, disposal |
| `PHIẾU TỰ SINH, IN, KẾ TOÁN, HOẠCH TOÁN.md` | `01-P2-THIẾT KẾ KỸ THUẬT VẬN HÀNH LÕI.md`, `06-P2-TRUY XUẤT QR THU HỒI VÀ KHÓA BÁN.md` | Ranh giới click chọn/tự hiện/nhập tay, print, kế toán/MISA handoff |
